package behavioral.iterator.eg2.before;

import java.util.Collection;
import java.util.TreeSet;

/**
 * The class SomeClassWithData provides access to its internal data structure. 
 * Clients can accidently or maliciously trash that data structure. 
 */
