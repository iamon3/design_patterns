package behavioral.visitor.eg5;

import java.lang.reflect.Method;

/**
 * Problem."If you want to add a new Visitable object, you have to change the Visitor interface, 
 * and then implement that method in each of your Visitors."
 * Solution. With the ReflectiveVisitor, you only need one method in the Visitor interface - visit(Object). 
