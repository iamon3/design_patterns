package structural.adapter.eg1.before;
 ...
 * the user/client has to recover the type of each shape and manually supply the correct arguments.
 */
public class AdapterDemo
{
	public static void main(String[] args)
	{
		...
		// Depending on the shape, draw corresponding shape.
