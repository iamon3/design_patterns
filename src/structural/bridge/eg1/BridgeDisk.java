...
class BridgeDisc {
	public static void main( String[] args ) {
		...
		// 2 implementations of of Collection of Stacks i.e. Array and List
		...
		// Print which elements could not be removed
